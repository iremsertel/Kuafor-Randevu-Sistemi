...
echo "<h1>Randevu Sil</h1>";
echo "<table border=1 id='tablo'>";
echo "<tr><th>Randevu No</th><th>Adı</th><th>Soyadı</th><th>Telefonu</th><th>Tarih</th><th>Saat</th></tr>";
...
while($gelen=mysqli_fetch_array($cevap))
{
  ...
  echo "<td><a href=kayitsil.php?id=".$gelen['randevuno'].">Sil</a></td></tr>";    
}
